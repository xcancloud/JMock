...
import static cloud.xcan.comp.jmock.core.function.basic.MDouble.DEFAULT_SCALE_VALUE;
...
public class MDoubleMockConstructorTest {
  ...
  public void MDouble1() throws Exception {
    ...
    Assert.assertEquals(DEFAULT_SCALE_VALUE, mock.getScale());
    Assert.assertEquals(DEFAULT_MAX_VALUE, mock.getMax(), 1);
