package cloud.xcan.comp.jmock.core.function.user.mfirstname;
...
import cloud.xcan.comp.jmock.core.function.user.MFirstname;
...
public class MFirstnameMockTest {
  ...
  String chinaFirstname = MessageResources.getString(JMockMessage.FDATA_FIRSTNAME, CHINA);
  ArrayList<String> china = Lists.newArrayList(chinaFirstname.split("\\|"));

  String str = "上官|慕容";
  ArrayList<String> dist = Lists.newArrayList(str.split("\\|"));

  String englishFirstname = MessageResources.getString(JMockMessage.FDATA_FIRSTNAME, ENGLISH);
