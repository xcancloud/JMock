package cloud.xcan.comp.jmock.core.function.geography.mcountry;

import cloud.xcan.comp.jmock.api.FunctionToken;
import cloud.xcan.comp.jmock.api.i18n.JMockResources;
import cloud.xcan.comp.jmock.api.i18n.MessageResources;
import cloud.xcan.comp.jmock.core.function.geography.MCountry;
...
public class MCountryMockTest {
  ...
  public void case1_defaultConstructorTest() throws Exception {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      String countryResources = MessageResources.getString(JMockResources.COUNTRY, Locale.CHINA);
  ...
  public void case2_localTest() throws Exception {
    ...
    for (int i = 0; i < 10; i++) {
      String str = mock.mock();
      String countryResources = MessageResources.getString(JMockResources.COUNTRY, Locale.ENGLISH);
      String country = new String(countryResources.getBytes(StandardCharsets.ISO_8859_1),
          StandardCharsets.UTF_8);
      Assertions.assertTrue(country.contains(str));
    }
