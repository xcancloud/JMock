...
import static cloud.xcan.jmock.api.i18n.JMockFuncDocMessage.DOC_LOCALE_TIME_C1;
import static cloud.xcan.jmock.api.i18n.JMockFuncDocMessage.DOC_LOCALE_TIME_C2;
import static cloud.xcan.jmock.api.i18n.JMockFuncDocMessage.DOC_LOCALE_TIME_C3;
import static cloud.xcan.jmock.api.i18n.JMockFuncDocMessage.DOC_LOCALE_TIME_C4;
import static cloud.xcan.jmock.api.i18n.JMockFuncDocMessage.DOC_LOCALE_TIME_DESC;
import static cloud.xcan.jmock.api.i18n.JMockFuncDocMessage.DOC_LOCALE_TIME_PARAMETER_FORMAT;
import static cloud.xcan.jmock.api.i18n.JMockFuncDocMessage.DOC_LOCALE_TIME_PARAMETER_RANDOM;
...
@Setter
@Getter
@JMockFunctionRegister(descI18nKey = DOC_LOCALE_TIME_DESC,
...
public class MLocaleTime extends AbstractMockFunction {
  ...
  @JMockConstructor(descI18nKey = DOC_LOCALE_TIME_C1,
      example = "@LocaleTime()",
  ...
  @JMockConstructor(descI18nKey = DOC_LOCALE_TIME_C2,
  ...
  @JMockConstructor(descI18nKey = DOC_LOCALE_TIME_C3,
      example = "@LocaleTime(a HH:mm:ss)",
      exampleValues = {"下午 23:34:25", "下午 23:34:25"})
  ...
  @JMockConstructor(descI18nKey = DOC_LOCALE_TIME_C4,
