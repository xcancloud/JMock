...
public class TypeUtils {
   ...
   *
   * <p>
   * Example: {@link java.util.TreeSet TreeSet} sets its parameter as the parameter for {@link
   ...
   * java.lang.Iterable}. Since {@code TreeSet}'s parameter maps (indirectly) to {@code Iterable}'s
   * parameter, it will be able to determine that based on the super type {@code Iterable<? extends
   * Map<Integer, ? extends Collection<?>>>}, the parameter of {@code TreeSet} is {@code ? extends
   * Map<Integer, ? extends Collection<?>>}.
   * </p>
   *
   * @param cls                    the class whose type parameters are to be determined, not {@code
   *                               null}
   ...
   * above example, this method will also determine that the type arguments for {@link
