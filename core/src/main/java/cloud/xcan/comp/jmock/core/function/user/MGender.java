...
import static cloud.xcan.comp.jmock.api.i18n.JMockFuncDocMessage.DOC_MGENDER_C1;
import static cloud.xcan.comp.jmock.api.i18n.JMockFuncDocMessage.DOC_MGENDER_C2;
import static cloud.xcan.comp.jmock.api.i18n.JMockFuncDocMessage.DOC_MGENDER_C3;
import static cloud.xcan.comp.jmock.api.i18n.JMockFuncDocMessage.DOC_MGENDER_DESC;
import static cloud.xcan.comp.jmock.api.i18n.JMockFuncDocMessage.DOC_MGENDER_PARAMETER_DICT;
...
public class MGender extends AbstractMockFunction {
  ...
  public MGender(Locale locale) {
    String lastName = MessageResources.getString(JMockMessage.FDATA_GENDER, locale);
