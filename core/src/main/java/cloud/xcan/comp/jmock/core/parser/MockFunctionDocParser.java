...
import static cloud.xcan.comp.jmock.api.i18n.MessageResources.getString;
...
import cloud.xcan.comp.jmock.core.parser.docs.model.MockConstructor;
import cloud.xcan.comp.jmock.core.parser.docs.model.MockFunction;
import cloud.xcan.comp.jmock.core.parser.docs.model.MockParameter;
...
public class MockFunctionDocParser {
  ...
  public List<MockFunction> parse(SupportedLanguage language) {
    ...
    Map<String, Class<? extends cloud.xcan.comp.jmock.api.MockFunction>> mfClazz = environment.getMockClass();
    if (isEmpty(mfClazz)) {
      return mockFunctions;
    }
    for (Entry<String, Class<? extends cloud.xcan.comp.jmock.api.MockFunction>> entry : mfClazz.entrySet()) {
