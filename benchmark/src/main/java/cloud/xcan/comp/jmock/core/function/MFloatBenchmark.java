 ...
 *  </pre>
 */
public class MFloatBenchmark extends AbstractBenchmark {

  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder()
        .include(MFloatBenchmark.class
            .getSimpleName())
//        .threads(1)
        .threads(5)
        .build();
  ...
  MFloat defaultAllowNull;

  @Benchmark
  public Float mockRangeValue() {
  ...
  public void setUp() throws Exception {
    ...
    FunctionToken token = new FunctionToken("Float",
        new String[]{null, "1002", null, "1:9"});
    this.defaultAllowNull = (MFloat) parser.parse(token);
