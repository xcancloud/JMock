 ...
 *  # Benchmark                                 Mode    Cnt      Score             Error  Units
 *  # MCoordinatesBenchmark.defaultConstructor  thrpt    3  3365825.268 ± 7097241.388  ops/s
 *  </pre>
 */
//TODO 不合格
public class MCoordinatesBenchmark extends AbstractBenchmark {

  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder()
        .include(MCoordinatesBenchmark.class
            .getSimpleName())
//        .threads(1)
        .threads(5)
        .build();
  ...
  MCoordinates defaultConstructor;
  ...
  public void setUp() throws Exception {
    ...
    FunctionToken token = new FunctionToken("Coordinates",
        new String[]{});
    this.defaultConstructor = (MCoordinates) parser.parse(token);
