 ...
 *  # Benchmark                               Mode  Cnt        Score         Error  Units
 *  # MLatitudeBenchmark.defaultConstructor  thrpt    3  1090330.566 ± 2081899.693  ops/s
 *  </pre>
 */
//TODO 不合格
public class MLatitudeBenchmark extends AbstractBenchmark {

  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder()
        .include(MLatitudeBenchmark.class
            .getSimpleName())
        .threads(1)
//        .threads(5)
        .build();
  ...
  public void setUp() throws Exception {
    ...
    FunctionToken token = new FunctionToken("Latitude",
        new String[]{});
    this.defaultConstructor = (MLatitude) parser.parse(token);
