 ...
 *  # Benchmark                           Mode  Cnt        Score        Error  Units
 *  # MUuidBenchmark.defaultConstructor  thrpt    3  1840418.145 ± 148811.732  ops/s
 *  </pre>
 */
//TODO 不合格
public class MUuidBenchmark extends AbstractBenchmark {

  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder()
        .include(MUuidBenchmark.class
            .getSimpleName())
        .threads(1)
//        .threads(5)
        .build();
  ...
  public void setUp() throws Exception {
    ...
    FunctionToken token = new FunctionToken("Uuid",
        new String[]{});
    this.defaultConstructor = (MUuid) parser.parse(token);
