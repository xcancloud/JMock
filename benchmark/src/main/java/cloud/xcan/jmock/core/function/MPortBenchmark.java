...
import cloud.xcan.jmock.core.function.network.MPort;
 ...
 *  # MPortBenchmark.defaultConstructor  thrpt    3  129314845.888 ± 90082044.906  ops/s
 *  * ============================
 *  # Threads: 5 threads, will synchronize iterations
 *  # Benchmark                           Mode  Cnt          Score           Error  Units
 *  # MPortBenchmark.defaultConstructor  thrpt    3  577443761.831 ± 346504374.340  ops/s
 *  </pre>
 */
public class MPortBenchmark extends AbstractBenchmark {

  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder()
        .include(MPortBenchmark.class
            .getSimpleName())
//        .threads(1)
        .threads(5)
        .build();
  ...
  public void setUp() throws Exception {
    ...
    FunctionToken token = new FunctionToken("Port",
        new String[]{});
    this.defaultConstructor = (MPort) parser.parse(token);
