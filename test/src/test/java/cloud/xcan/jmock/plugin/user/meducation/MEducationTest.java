...
public class MEducationTest {
  ...
  public void case1_defaultConstructorTest() throws Exception {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      String country = MessageResources.getString(UserDocMessage.DATA_EDUCATION, Locale.CHINA);
  ...
  public void case2_localTest() throws Exception {
    ...
    for (int i = 0; i < 10; i++) {
      String str = mock.mock();
      String countryResources = MessageResources.getString(UserDocMessage.DATA_EDUCATION,
          Locale.ENGLISH);
