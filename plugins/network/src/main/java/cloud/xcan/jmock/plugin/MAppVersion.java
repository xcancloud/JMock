...
import static cloud.xcan.jmock.api.support.utils.AppVersionUtils.appVersion;
import static cloud.xcan.jmock.plugin.NetworkDocMessage.DOC_APP_VERSION_C1;
import static cloud.xcan.jmock.plugin.NetworkDocMessage.DOC_APP_VERSION_C2;
import static cloud.xcan.jmock.plugin.NetworkDocMessage.DOC_APP_VERSION_C3;
import static cloud.xcan.jmock.plugin.NetworkDocMessage.DOC_APP_VERSION_C4;
import static cloud.xcan.jmock.plugin.NetworkDocMessage.DOC_APP_VERSION_DESC;
import static cloud.xcan.jmock.plugin.NetworkDocMessage.DOC_APP_VERSION_PARAMETER_BUILD_STATE_DICT;
import static cloud.xcan.jmock.plugin.NetworkDocMessage.DOC_APP_VERSION_PARAMETER_PREFIX_DICT;
import static cloud.xcan.jmock.plugin.NetworkDocMessage.DOC_APP_VERSION_PARAMETER_RELEASE_STATE_DICT;
...
@Setter
@Getter
@JMockFunctionRegister(descI18nKey = DOC_APP_VERSION_DESC,
...
public class MAppVersion extends AbstractMockFunction {
  ...
  @JMockConstructor(descI18nKey = DOC_APP_VERSION_C1,
      example = "@AppVersion()",
  ...
  @JMockConstructor(descI18nKey = DOC_APP_VERSION_C2,
  ...
  @JMockConstructor(descI18nKey = DOC_APP_VERSION_C3,
  ...
  @JMockConstructor(descI18nKey = DOC_APP_VERSION_C4,
