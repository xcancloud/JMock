...
import static cloud.xcan.jmock.api.i18n.JMockMessage.PARAM_LENGTH_T;
import static cloud.xcan.jmock.plugin.LocaleDocMessage.DOC_CATEGORY_LOCALE;
import static cloud.xcan.jmock.plugin.LocaleDocMessage.DOC_LOCALE_C1;
import static cloud.xcan.jmock.plugin.LocaleDocMessage.DOC_LOCALE_C2;
import static cloud.xcan.jmock.plugin.LocaleDocMessage.DOC_LOCALE_DESC;
import static cloud.xcan.jmock.plugin.LocaleDocMessage.DOC_LOCALE_PARAMETER_JOINER;
...
public class MLocale extends AbstractMockFunction {
  ...
  public MLocale(String joiner) {
    if (joiner == null || joiner.isEmpty()) {
      ...
      if (joiner.length() > 1) {
        ParamParseException.throw0(PARAM_LENGTH_T, new Object[]{"joiner", 1});
      }
      this.joiner = joiner;
    }
  }
