...
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_DOUBLE_C3;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_DOUBLE_C4;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_DOUBLE_C5;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_DOUBLE_C6;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_DOUBLE_DESC;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_DOUBLE_PARAMETER_MAX;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_DOUBLE_PARAMETER_MIN;
...
public class MDouble extends AbstractMockFunction {
  ...
  public MDouble(Double min, Double max, Integer scale, String nullWeight) {
    if (min == null || min < 0) {
      ParamParseException.throw0(PARAM_MIN_T, new Object[]{"min", 0});
    }
    ...
    if (scale == null) {
      ...
      ParamParseException.throw0(PARAM_SIZE_T, new Object[]{"scale", 0, MAX_SCALE_VALUE});
    } else {
      this.scale = scale;
    }
  }
