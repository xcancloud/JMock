...
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_FLOAT_C1;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_FLOAT_C2;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_FLOAT_C3;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_FLOAT_C4;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_FLOAT_C5;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_FLOAT_C6;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_FLOAT_DESC;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_FLOAT_PARAMETER_MAX;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_FLOAT_PARAMETER_MIN;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_FLOAT_PARAMETER_SCALE;
...
public class MFloat extends AbstractMockFunction {
  ...
  public MFloat(Float min, Float max, Integer scale, String nullWeight) {
    ...
    if (max == null || max <= 0) {
      ParamParseException.throw0(PARAM_MIN_T, new Object[]{"max", 0});
    }
    if (this.min > max) {
