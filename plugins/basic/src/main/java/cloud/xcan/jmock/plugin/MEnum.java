...
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_ENUM_C3;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_ENUM_DESC;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_ENUM_PARAMETER_DICT;
...
public class MEnum extends AbstractMockFunction {
  ...
  public MEnum(String dict, String valueWeight, String nullWeight) {
    ...
    if (StringUtils.isBlank(valueWeight)) {
      ParamParseException.throw0(PARAM_NOT_NULL_T, new Object[]{"valueWeight"});
    }
