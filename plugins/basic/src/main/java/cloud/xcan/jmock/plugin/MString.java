...
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_STRING_C3;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_STRING_C4;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_STRING_C5;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_STRING_C6;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_STRING_DESC;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_STRING_PARAMETER_CHARS;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_STRING_PARAMETER_LENGTH;
import static cloud.xcan.jmock.plugin.BasicDocMessage.DOC_STRING_PARAMETER_MAX;
...
public class MString extends AbstractMockFunction {
   ...
   */
  @JMockConstructor(descI18nKey = DOC_STRING_C6,
