...
import static cloud.xcan.jmock.plugin.GeographyDocMessage.DOC_PROVINCE_C1;
import static cloud.xcan.jmock.plugin.GeographyDocMessage.DOC_PROVINCE_C2;
import static cloud.xcan.jmock.plugin.GeographyDocMessage.DOC_PROVINCE_C3;
import static cloud.xcan.jmock.plugin.GeographyDocMessage.DOC_PROVINCE_DESC;
...
public class MProvince extends AbstractMockFunction {
  ...
  public MProvince(Locale locale) {
    String province = MessageResources.getString(GeographyDocMessage.DATA_PROVINCE, locale);
