...
import static cloud.xcan.jmock.plugin.GeographyDocMessage.DOC_ADDRESS_C1;
import static cloud.xcan.jmock.plugin.GeographyDocMessage.DOC_ADDRESS_C2;
import static cloud.xcan.jmock.plugin.GeographyDocMessage.DOC_ADDRESS_C3;
import static cloud.xcan.jmock.plugin.GeographyDocMessage.DOC_ADDRESS_DESC;
...
public class MAddress extends AbstractMockFunction {
  ...
  public MAddress(Locale locale) {
    String province = MessageResources.getString(GeographyDocMessage.DATA_ADDRESS, locale);
