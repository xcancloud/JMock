...
import static cloud.xcan.jmock.api.support.utils.RandomEmailUtils.email;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_CATEGORY_USER;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_EMAIL_C1;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_EMAIL_C2;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_EMAIL_C3;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_EMAIL_C4;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_EMAIL_DESC;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_EMAIL_PARAMETER_MAX;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_EMAIL_PARAMETER_MIN;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_EMAIL_PARAMETER_SUFFIX;
