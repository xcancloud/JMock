...
import static cloud.xcan.jmock.api.support.utils.RandomStringUtils.randomPassword;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_CATEGORY_USER;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_PASSWORD_C1;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_PASSWORD_C2;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_PASSWORD_C3;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_PASSWORD_C4;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_PASSWORD_DESC;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_PASSWORD_PARAMETER_ALLOW_DIGITS;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_PASSWORD_PARAMETER_ALLOW_LOWERCASE;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_PASSWORD_PARAMETER_ALLOW_SPECIALCHAR;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_PASSWORD_PARAMETER_ALLOW_UPPERCASE;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_PASSWORD_PARAMETER_MAX;
import static cloud.xcan.jmock.plugin.UserDocMessage.DOC_PASSWORD_PARAMETER_MIN;
...
@Setter
@Getter
@JMockFunctionRegister(descI18nKey = DOC_PASSWORD_DESC,
...
public class MPassword extends AbstractMockFunction {
  ...
  @JMockConstructor(descI18nKey = DOC_PASSWORD_C1,
      example = "@Passd()",
  ...
  @JMockConstructor(descI18nKey = DOC_PASSWORD_C2,
      example = "@Passd(5,8)",
  ...
  @JMockConstructor(descI18nKey = DOC_PASSWORD_C3,
  ...
  @JMockConstructor(descI18nKey = DOC_PASSWORD_C4,
  ...
  public MPassword(int min, int max, boolean allowUpperCase, boolean allowLowerCase,
    ...
    this.max = max;
    if (max > 65535) {
      ParamParseException.throw0(PARAM_MAX_T, new Object[]{"max", 65535});
    }
    if (min < 1) {
