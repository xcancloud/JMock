...
import static cloud.xcan.jmock.plugin.IDDocMessage.DOC_INCID_C1;
import static cloud.xcan.jmock.plugin.IDDocMessage.DOC_INCID_C2;
import static cloud.xcan.jmock.plugin.IDDocMessage.DOC_INCID_DESC;
import static cloud.xcan.jmock.plugin.IDDocMessage.DOC_INCID_PARAMETER_INIT;
import static cloud.xcan.jmock.plugin.IDDocMessage.DOC_INCID_PARAMETER_STEP;
...
public class MIncId extends AbstractMockFunction {
  ...
  public MIncId(Integer init, Integer step) {
    if (step != null && step < DEFAULT_STEP_VALUE) {
      ParamParseException.throw0(PARAM_MIN_T, new Object[]{"step", DEFAULT_STEP_VALUE});
    }
