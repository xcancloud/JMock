...
import static cloud.xcan.jmock.plugin.DateDocMessage.DOC_LOCALE_TIME_C1;
import static cloud.xcan.jmock.plugin.DateDocMessage.DOC_LOCALE_TIME_C2;
import static cloud.xcan.jmock.plugin.DateDocMessage.DOC_LOCALE_TIME_C3;
import static cloud.xcan.jmock.plugin.DateDocMessage.DOC_LOCALE_TIME_C4;
import static cloud.xcan.jmock.plugin.DateDocMessage.DOC_LOCALE_TIME_DESC;
import static cloud.xcan.jmock.plugin.DateDocMessage.DOC_LOCALE_TIME_PARAMETER_FORMAT;
import static cloud.xcan.jmock.plugin.DateDocMessage.DOC_LOCALE_TIME_PARAMETER_RANDOM;
