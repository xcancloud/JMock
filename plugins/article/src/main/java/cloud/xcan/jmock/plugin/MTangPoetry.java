...
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_TANGPOETRY_C1;
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_TANGPOETRY_C2;
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_TANGPOETRY_C3;
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_TANGPOETRY_DESC;
...
public class MTangPoetry extends AbstractMockFunction {
  ...
  public MTangPoetry(Locale locale) {
    String title = MessageResources.getString(ArticleDocMessage.DATA_TANG_POETRY, locale);
