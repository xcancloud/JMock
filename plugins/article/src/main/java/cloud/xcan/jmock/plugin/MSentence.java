...
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_SENTENCE_C1;
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_SENTENCE_C2;
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_SENTENCE_C3;
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_SENTENCE_DESC;
...
public class MSentence extends AbstractMockFunction {
  ...
  public MSentence(Locale locale, String dict) {
    ...
    if (ObjectUtils.isEmpty(dict)) {
      String sentenceResources = MessageResources.getString(ArticleDocMessage.DATA_SENTENCE,
          locale);
