...
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_WORD_C1;
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_WORD_C2;
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_WORD_C3;
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_WORD_DESC;
...
@Setter
@Getter
@JMockFunctionRegister(descI18nKey = DOC_WORD_DESC,
...
public class MWord extends AbstractMockFunction {
  ...
  @JMockConstructor(descI18nKey = DOC_WORD_C1,
      example = "@Word()",
  ...
  @JMockConstructor(descI18nKey = DOC_WORD_C2,
      example = "@Word(en)",
      exampleValues = {"along", "designer"})
  public MWord(Locale locale) {
    String title = MessageResources.getString(ArticleDocMessage.DATA_WORD, locale);
