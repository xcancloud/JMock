...
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_PARAGRAPH_C1;
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_PARAGRAPH_C2;
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_PARAGRAPH_C3;
import static cloud.xcan.jmock.plugin.ArticleDocMessage.DOC_PARAGRAPH_DESC;
...
@Setter
@Getter
@JMockFunctionRegister(descI18nKey = DOC_PARAGRAPH_DESC,
...
public class MParagraph extends AbstractMockFunction {
  ...
  @JMockConstructor(descI18nKey = DOC_PARAGRAPH_C1,
      example = "@Paragraph()",
      exampleValues = {
  ...
  @JMockConstructor(descI18nKey = DOC_PARAGRAPH_C2,
  ...
  public MParagraph(Locale locale) {
    String title = MessageResources.getString(ArticleDocMessage.DATA_PARAGRAPH, locale);
    this.dictArray = title.split("\\|");
  }

  @JMockConstructor(descI18nKey = DOC_PARAGRAPH_C3,
