...
export default function PlaygroundPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <p className="text-slate-500 mb-8">Enter a JMock template and generate mock data instantly.</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <pre className="w-full h-80 font-mono text-sm p-4 border rounded-lg bg-slate-50 overflow-auto whitespace-pre-wrap">
